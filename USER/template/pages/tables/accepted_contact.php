...
<head>
  ...
  include('../../../../Database/accepted_works.php');
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Contacts (Accepted)</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php
                            $counter=1;
                            foreach ($_SESSION['accepted_data'] as $row) {
                          ?>
                        <tr>
                          ...
                          <td class="d_td">
                            <?php echo $row['work_brief']; ?>
                          </td>
                          <td>
                          ₹ <?php echo $row['work_charge'] ?>
                          </td>
