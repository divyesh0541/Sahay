...
<head>
  ...
  include('../../../../Database/show_accepted_works.php');
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Work Posted (Accepted)</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                          <?php
                            $counter=1;
                            foreach ($_SESSION['show_accepted_data'] as $row) {
                          ?>
                        <tr>
                          ...
                          <td>
                           <?php echo $row['user_skill'] ?>
                          </td>
                          <td class="d_td2" >
                            <form method="post">
                               <td>
                            <a href="#" class="d_connect">Done</a>
                            </td>
