...
<head>
  ...
  include('../../../../Database/work_enquires.php');
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="../../index.html">
            <img src="../../../../img/logo3.png" alt="logo" style="width:125% !important"/>
          </a>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="../../../../img/IMG-0283.jpg" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="../../../../img/IMG-0283.jpg" alt="Profile image">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Work Posted (Pending)</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                       <?php
                            $counter=1;
                             //print_r($_SESSION['enquires_data']);
                            foreach ($_SESSION['enquires_data'] as $row) {
                        ...
                        <tr>
                         ...
                         <!--  <td>
                          ...
                          -->   <td>
                            <a href="#" class="d_connect">Give Contact</a>
                            <form method="post" action="../../../../Database/hire.php">
                              <input type="hidden" name="work_id" value="<?php echo $row['work_id']; ?>"/>
                              <input type="hidden" name="user_id" value="<?php  echo $row['service_user_id'];?>"/>
                            <input type="submit"  class="d_connect" value="Hire"/>
                          </form>
                          </td>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright 2023 © Sahay. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
