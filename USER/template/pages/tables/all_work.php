...
<head>
     <?php
      ...
      include('../../../../Database/show_work.php');
     //session_start();
     ...
     header('Location:../../../../login.php');
        ...
        if(!isset($_SESSION['data'])){
            header('Location: ../../../../add_work.login');
        }
    ...
    <?php
                      if(isset($_POST['apply'])){
                        ...
                        $stmt = $conn->prepare("INSERT INTO work_enquirey (work_id, user_id) VALUES (?, ?)");
                        $stmt->bind_param("ss", $_POST['work_id'],  $_SESSION['user_id']);
                        $stmt->execute();
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator" id="notificationDropdown" href="signout" data-bs-toggle="dropdown">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Explore Works</h4>
                  <p class="card-description">
                  By<code>All Users</code>
                  </p>
